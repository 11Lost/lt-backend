...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    GearImage: Schema.Attribute.Component<'components.gear-image', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    KeynoteSpeakers: Schema.Attribute.Component<
      'components.keynote-speakers',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    >;
    Partners: Schema.Attribute.Component<'components.partners', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    Services: Schema.Attribute.Component<'components.our-services', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    TopBanner: Schema.Attribute.Component<'components.banner', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiRegisterRegister extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CurrentBaseLocation: Schema.Attribute.String;
    Designation: Schema.Attribute.String;
    EmailAddress: Schema.Attribute.Email;
    FullName: Schema.Attribute.Text;
    IWantToAttendRaise: Schema.Attribute.Enumeration<['InPerson', 'Online']>;
    ...
    > &
      Schema.Attribute.Private;
    MobileNumber: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
